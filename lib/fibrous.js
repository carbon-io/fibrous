// CodeClimate: don't ignore CoffeeScript 1.12.2
(function() {
  ...
  proxyBuilder = function(futureOrSync) {
    return function(that) {
      ...
      if (typeof that === 'function') {
        func = (futureOrSync === 'future' && futureize || synchronize)(that);
        if (Object.getPrototypeOf(that) !== Function.prototype) {
          func.__proto__ = Object.getPrototypeOf(that)[futureOrSync];
        }
        result = func;
      } else {
        if (Object.getPrototypeOf(that) && Object.getPrototypeOf(that)[futureOrSync]) {
          result = Object.getPrototypeOf(that)[futureOrSync];
        } else {
